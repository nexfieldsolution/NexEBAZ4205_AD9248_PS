# NexEBAZ4205_DAC904_PS constraints
# EBAZ4205 + 660Z069A_V13 IO board + 14BIT 165MSPS DAC (DAC904)
...
# DAC (14BIT 165MSPS DAC board, 660Z069A_V13 IO board pos 5~12)
# CLK: D18 (pos 5A, 초단거리 점퍼)
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports dac_clk]
# D0~D12: 직접 연결 / D1,D3,D8,D10,D13: 점퍼
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {dac_data[0]}]
set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS33} [get_ports {dac_data[1]}]
set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports {dac_data[2]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {dac_data[3]}]
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33} [get_ports {dac_data[4]}]
set_property -dict {PACKAGE_PIN H20 IOSTANDARD LVCMOS33} [get_ports {dac_data[5]}]
set_property -dict {PACKAGE_PIN G20 IOSTANDARD LVCMOS33} [get_ports {dac_data[6]}]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports {dac_data[7]}]  
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {dac_data[8]}]
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports {dac_data[9]}]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {dac_data[10]}]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {dac_data[11]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {dac_data[12]}]
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} [get_ports {dac_data[13]}]

# ── 비동기 클럭 도메인 선언 ────────────────────────────────────────────
# FCLKCLK[0], CLKOUT0, CLKOUT1 는 서로 비동기 클록
set_clock_groups -asynchronous \
    -group [get_clocks -of_objects [get_pins {u_ps7/design_1_i/processing_system7_0/inst/PS7_i/FCLKCLK[0]}]] \
    -group [get_clocks -of_objects [get_pins u_clocking/mmcm_inst/CLKOUT0]] \
    -group [get_clocks -of_objects [get_pins u_clocking/mmcm_inst/CLKOUT1]]
